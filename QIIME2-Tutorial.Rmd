...
**Note**: This tutorial assumes you have installed [QIIME2](https://qiime2.org/) using one of the procedures in the [install documents](https://docs.qiime2.org/2020.2/install/). This tutorial also assumes you have installed [SCRuB](https://korem-lab.github.io/SCRuB/).
...
scrubbed = SCRuB(table, 
                ...
                'control blank library prep,control blank DNA extraction' # order of decontamination
                )
```
