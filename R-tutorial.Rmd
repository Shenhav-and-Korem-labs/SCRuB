...
Alternatively, SCRuB can be run using `biom` objects, and by inputting the paths to the input files. The file formats for the inputs can be found [here](https://github.com/korem-lab/SCRuB/tree/gh-pages_tmp). 
```{r}
